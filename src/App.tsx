              ...
              <div className="grid grid-cols-12 gap-3 sm:gap-6 lg:gap-8 items-start w-full">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="bg-[#0f1c2e] p-2.5 sm:p-6 md:p-8 rounded-lg shadow-sm border border-gray-800 w-full"
                  >
                    <div className="flex items-center gap-2 sm:gap-4 mb-1.5 sm:mb-4">
                      <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-[#965F0E]/20 flex items-center justify-center shrink-0">
                        <span className="material-symbols-outlined text-[#965F0E] text-xs sm:text-xl font-bold">real_estate_agent</span>
                      </div>
                      <div>
                        <h4 className="font-headline-lg text-[10px] sm:text-[13px] md:text-[15px] leading-tight text-white uppercase tracking-wider font-extrabold">
                          Support Customer
                        </h4>
                      </div>
                    </div>
                    
                    <p className="font-body-md text-gray-300 mb-2 sm:mb-4 border-b border-white/10 pb-1.5 sm:pb-3 text-[9px] sm:text-[11px] md:text-xs tracking-wide">
                      Over 12 Years of Excellence
                    </p>
                    
                    <div className="flex flex-col sm:flex-row gap-1 justify-between items-start sm:items-center text-gray-300 font-label-bold text-[8px] sm:text-[9px] md:text-[10px] uppercase tracking-widest font-bold">
                      <div className="flex items-center gap-1"><span className="material-symbols-outlined text-[#965F0E] text-[10px] sm:text-[13px] font-bold">verified</span> Trusted</div>
                      <div className="flex items-center gap-1"><span className="material-symbols-outlined text-[#965F0E] text-[10px] sm:text-[13px] font-bold">visibility</span> Transparent</div>
                      <div className="flex items-center gap-1"><span className="material-symbols-outlined text-[#965F0E] text-[10px] sm:text-[13px] font-bold">favorite</span> Dedicated</div>
                    </div>
                  </motion.div>
                </motion.div>
                ...
                >
                  <div className="bg-white border border-gray-100 rounded-t-lg px-2.5 sm:px-6 py-2 sm:py-4 flex flex-row items-center justify-between gap-2 shadow-2xs">
                    {/* Brand Text Logo left */}
                    <div className="flex items-center gap-1 sm:gap-2">
                      <span className="font-display-lg text-[9px] sm:text-[11px] md:text-[13px] tracking-[0.15em] sm:tracking-[0.25em] font-extrabold text-black uppercase">SHILA</span>
                      <span className="text-[7px] sm:text-[8px] md:text-[9px] uppercase tracking-[0.1em] sm:tracking-[0.15em] text-gray-400 font-bold border-l border-gray-200 pl-1 sm:pl-2">SAWANGAN</span>
                    </div>
                    ...
                    <button 
                      ...
                      className="bg-[#965F0E] hover:bg-[#804f0b] text-white transition-colors font-bold text-[8px] sm:text-[10px] md:text-[11px] uppercase tracking-widest py-1.5 sm:py-3 px-2 sm:px-6 flex items-center gap-1 sm:gap-2 rounded-sm cursor-pointer shadow-sm text-center whitespace-nowrap border-none focus:outline-none"
                    >
                      EXPLORE PROPERTIES
                      <span className="material-symbols-outlined text-[10px] sm:text-sm">north_east</span>
                    </button>
                  </div>
                ...
                <div className="max-w-2xl mx-auto w-full">
                  <div className="bg-white shadow-xs rounded-full p-1.5 flex items-center border border-gray-100 focus-within:border-[#965F0E] transition-all">
                    <div className="flex-1 flex items-center px-3 sm:px-4 min-w-0">
                      <span className="material-symbols-outlined text-gray-400 mr-2 text-sm sm:text-lg shrink-0">search</span>
                      <input 
                        type="text" 
                        ...
                        <div className="p-4 sm:p-6 md:p-7 flex flex-col flex-grow justify-between">
                          <div>
                            <div className="flex justify-between items-start mb-2 sm:mb-3 gap-2">
                              ...
                              >
                                <span className={`material-symbols-outlined text-[16px] sm:text-[18px] ${isFav ? 'fill-current' : ''}`}>favorite</span>
                              </button>
                            </div>

                            <div className="flex items-center gap-1 text-gray-400 mb-3 sm:mb-5">
                              <span className="material-symbols-outlined text-[#965F0E] text-[15px] sm:text-[16px] font-bold">location_on</span>
                            ...
                            <div className="flex items-center gap-4 sm:gap-6 py-3 sm:py-4.5 border-y border-gray-100 mb-4 sm:mb-6 text-gray-700">
                              <div className="flex items-center gap-1 sm:gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[15px] sm:text-[17px] font-bold">bed</span>
                                <span className="text-xs font-bold">{property.bedrooms} <span className="text-gray-400 font-normal">Beds</span></span>
                              </div>
                              <div className="flex items-center gap-1 sm:gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[15px] sm:text-[17px] font-bold">bathtub</span>
                                <span className="text-xs font-bold">{property.bathrooms} <span className="text-gray-400 font-normal">Baths</span></span>
                              </div>
                              <div className="flex items-center gap-1 sm:gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[15px] sm:text-[17px] font-bold">layers</span>
