...
const theForestPhoto = '/images/south-bank/1.jpg';
const theForestPhoto = '/images/like-vista/1.jpg';
    ...
    <div id="app-wrapper" className="min-h-screen bg-white font-body-md text-[#111c2c] relative flex flex-col">
      ...
      <header className="w-full bg-white border-b border-gray-100 sticky top-0 z-40 shadow-xs">
        <div className="h-20 max-w-[1200px] mx-auto px-6 flex items-center justify-between">
          ...
          {/* Logo with Black Square S inside & tracked Silla Sawangan text */}
          <button 
            onClick={() => {
              setCurrentPage('home');
          ...
          >
            <div className="bg-black w-9 h-9 flex items-center justify-center font-extrabold text-white text-lg tracking-normal">
              S
            </div>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center gap-3 pl-3.5 pr-2 py-2 rounded-full border border-gray-200 hover:border-gray-400 bg-white shadow-xs transition-all cursor-pointer focus:outline-none"
              >
      ...
      <main className="flex-grow">
        ...
        {currentPage === 'home' ? (
          <>
            {/* HERO HEADER TEXT */}
            <section className="pt-12 md:pt-20 pb-8 px-6 max-w-[1200px] mx-auto w-full">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                
                {/* Left Header Title Block */}
                <div className="flex flex-col">
                  <span className="text-[11px] tracking-[0.25em] text-gray-400 font-bold uppercase mb-2">
                    FIND YOUR
                  </span>
                  <h1 className="font-display-lg text-black uppercase text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight">
                    PERFECT HOME
                  </h1>
                  <p className="font-body-md text-gray-500 mt-4 max-w-sm text-sm">
                    Modern living spaces di lokasi prima. Pilihan hunian terbaik dengan exceptional lifestyle.
                  </p>
                </div>
                
                {/* Right Header Trust Block */}
                <div className="flex flex-col md:pl-12 border-l-0 md:border-l border-gray-100 pt-6 md:pt-0">
                  <span className="font-bold text-xs uppercase tracking-[0.15em] text-black mb-2">
                    Trusted Since 2014
                  </span>
                  <p className="font-body-md text-gray-500 text-sm leading-relaxed max-w-md">
            ...
            {/* HERO IMAGE GRID - Side-by-Side (Matching screen.png perfectly on all viewports) */}
            <section className="pb-16 px-4 md:px-6 max-w-[1200px] mx-auto w-full">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-4 mb-2 sm:mb-4">
                      ...
                      <div>
                        <h4 className="font-headline-lg text-[8px] sm:text-[12px] md:text-[15px] leading-tight text-white uppercase tracking-wider font-extrabold">
                          Suport Costomer
                        </h4>
                      </div>
                    </div>
                    
                    <p className="font-body-md text-gray-300 mb-2 sm:mb-4 border-b border-white/10 pb-1.5 sm:pb-3 text-[7px] sm:text-[10px] md:text-xs tracking-wide">
                      Over 12 Years of Excellence
                    </p>
                    
                    <div className="flex flex-col sm:flex-row gap-1 justify-between items-start sm:items-center text-gray-300 font-label-bold text-[6px] sm:text-[8px] md:text-[10px] uppercase tracking-widest font-bold">
                      <div className="flex items-center gap-0.5"><span className="material-symbols-outlined text-[#965F0E] text-[8px] sm:text-[13px] font-bold">verified</span> Trusted</div>
                ...
                >
                  <div className="bg-white border border-gray-100 rounded-t-lg px-3 sm:px-6 py-2 sm:py-4 flex flex-row items-center justify-between gap-2 shadow-2xs">
                    ...
                    <button 
                      ...
                      className="bg-[#965F0E] hover:bg-[#804f0b] text-white transition-colors font-bold text-[7px] sm:text-[9px] md:text-[11px] uppercase tracking-widest py-1.5 sm:py-3 px-2 sm:px-6 flex items-center gap-1 sm:gap-2 rounded-sm cursor-pointer shadow-sm text-center whitespace-nowrap border-none focus:outline-none"
                    >
                      EXPLORE PROPERTIES
                      <span className="material-symbols-outlined text-[9px] sm:text-sm">north_east</span>
                    </button>
                  </div>
                  
                  {/* Pool Twilight Villa Large Photo */}
                  <div className="w-full aspect-[16/10] md:aspect-[16/9] rounded-b-lg overflow-hidden shadow-sm">
                    <img 
              ...
              >
                ...
                <div className="col-span-12 md:col-span-4 flex flex-col justify-center">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2.5 rounded bg-[#965F0E] hover:bg-[#804f0b] text-white text-[10px] sm:text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer shadow-sm border-none flex items-center gap-1.5"
                    >
                      Buka Halaman Properti
                      <span className="material-symbols-outlined text-xs">arrow_forward</span>
                    </button>
                  </div>
                </div>
                
                {/* Right side: 3 Category Cluster Cards (Directly navigates to Properties page with filtered cluster) */}
                <div className="col-span-12 md:col-span-8 grid grid-cols-3 gap-2 sm:gap-4 relative">
                  ...
                  <div 
                    ...
                    className={`relative h-[170px] sm:h-[290px] md:h-[370px] rounded-lg overflow-hidden group shadow-md border cursor-pointer transition-all duration-300 ${
                  ...
                  >
                    ...
                    {selectedCategory === 'THE FOREST' && (
                      <div className="absolute top-2.5 right-2.5 bg-[#965F0E] text-white text-[8px] sm:text-[10px] font-extrabold uppercase px-2 py-0.5 rounded-full shadow-md flex items-center gap-1">
                        <span className="material-symbols-outlined text-[10px] sm:text-xs">check_circle</span> Terpilih
                      </div>
                    )}

                    <div className="absolute bottom-2.5 sm:bottom-4 left-2 sm:left-3 right-2 sm:right-3 bg-[#0f1c2e]/95 backdrop-blur-xs p-2 sm:p-3 rounded border border-white/10 flex flex-col justify-center">
                      <span className="text-[#965F0E] text-[8px] sm:text-[10px] font-extrabold uppercase tracking-wider">Cluster 01</span>
                      <h4 className="text-white text-[10px] sm:text-sm font-extrabold leading-tight">THE FOREST</h4>
                      <p className="text-gray-300 text-[8px] sm:text-[10px] font-medium mt-0.5">Asri & Teduh</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="absolute bottom-2.5 sm:bottom-4 left-2 sm:left-3 right-2 sm:right-3 bg-[#0f1c2e]/95 backdrop-blur-xs p-2 sm:p-3 rounded border border-white/10 flex flex-col justify-center">
                      ...
                      <h4 className="text-white text-[10px] sm:text-sm font-extrabold leading-tight">SOUTH BANK</h4>
                      <p className="text-gray-300 text-[8px] sm:text-[10px] font-medium mt-0.5">Modern Minimalis</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="absolute bottom-2.5 sm:bottom-4 left-2 sm:left-3 right-2 sm:right-3 bg-[#0f1c2e]/95 backdrop-blur-xs p-2 sm:p-3 rounded border border-white/10 flex flex-col justify-center">
                      ...
                      <h4 className="text-white text-[10px] sm:text-sm font-extrabold leading-tight">LAKE VISTA</h4>
                      <p className="text-gray-300 text-[8px] sm:text-[10px] font-medium mt-0.5">Waterfront Luxury</p>
                    </div>
                  </div>
            ...
            <section className="py-10 sm:py-16 px-4 sm:px-6 max-w-[1200px] mx-auto w-full border-t border-gray-100 mt-4 sm:mt-8" id="about">
              <div className="grid grid-cols-12 gap-3 sm:gap-10 items-center">
                
                {/* Left Content Column */}
                <div className="col-span-7 flex flex-col justify-center">
                  <span className="text-[#965F0E] font-bold text-[7px] sm:text-xs tracking-widest uppercase mb-1 sm:mb-2">About Me</span>
                  <h2 className="text-black mb-2 sm:mb-5 font-extrabold uppercase tracking-tight text-[10px] sm:text-2xl md:text-3xl">
                    About Me
                  </h2>
            ...
            {/* READY TO FIND YOUR DREAM HOME BANNER (Exact visual match) */}
            <section className="py-20 px-6 max-w-[1200px] mx-auto w-full relative" id="contact">
              <div className="bg-[#0f1c2e] text-white rounded-lg p-8 md:p-14 text-center max-w-4xl mx-auto shadow-sm border border-gray-800">
                <h2 className="font-headline-xl text-xl md:text-2xl lg:text-3xl mb-3 font-extrabold uppercase tracking-tight">
                  Ready to Find Your Dream Home?
                </h2>
                <p className="font-body-md text-gray-300 mb-8 max-w-xl mx-auto text-xs md:text-sm">
                  Get in touch with our expert real estate agents today and start your journey.
                </p>
                <button 
                  onClick={() => setIsContactOpen(true)}
                  className="bg-[#965F0E] hover:bg-[#804f0b] text-white font-bold text-[11px] uppercase tracking-widest py-3.5 px-8 rounded-sm transition-all cursor-pointer shadow-sm"
                >
                  CONTACT US NOW
                </button>
              </div>
          ...
          <div className="flex flex-col w-full bg-white animate-fade-in">
                ...
                <div className="max-w-2xl mx-auto w-full">
                  <div className="bg-white shadow-xs rounded-full p-1.5 flex items-center border border-gray-100 focus-within:border-[#965F0E] transition-all">
                    <div className="flex-1 flex items-center px-4">
                      <span className="material-symbols-outlined text-gray-400 mr-2 text-sm sm:text-lg">search</span>
                      <input 
                        type="text" 
                        value={searchPropertiesQuery}
                        onChange={(e) => setSearchPropertiesQuery(e.target.value)}
                        placeholder="Search properties by name, location, or style..." 
                    ...
                    <button className="bg-[#965F0E] hover:bg-[#804f0b] text-white font-bold uppercase tracking-wider text-[10px] sm:text-xs px-4 sm:px-8 py-2 sm:py-3 rounded-full transition-colors flex items-center justify-center gap-1.5 cursor-pointer border-none focus:outline-none">
                      Search
                    </button>
                  </div>
                </div>
            ...
            <section className="py-12 px-6 max-w-[1200px] mx-auto w-full">
                ...
                <div className="flex items-center gap-3 self-end md:self-auto">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`flex items-center gap-2.5 px-4 py-2 rounded-full border transition-all cursor-pointer select-none ${
                        isCategoryDropdownOpen 
                          ? 'bg-white border-[#965F0E] shadow-md ring-2 ring-[#965F0E]/20' 
                          : 'bg-white hover:bg-gray-50 border-gray-200 shadow-2xs'
                      }`}
                    >
                      <span className="material-symbols-outlined text-sm text-[#965F0E]">tune</span>
                      ...
                      <span className={`material-symbols-outlined text-gray-500 text-sm transition-transform duration-200 ${isCategoryDropdownOpen ? 'rotate-180 text-[#965F0E]' : ''}`}>
                        expand_more
                      </span>
                    </button>
                        ...
                        <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-150 py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                          ...
                          <div className="p-1.5 space-y-1">
                            ...
                            >
                              ...
                              {selectedCategory === 'ALL' && (
                                <span className="material-symbols-outlined text-sm font-bold text-[#965F0E]">check</span>
                              )}
                            </button>
              ...
              {PROPERTIES.filter(property => {
                  ...
                  {PROPERTIES.filter(property => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-5 sm:p-6 md:p-7 flex flex-col flex-grow justify-between">
                          <div>
                            <div className="flex justify-between items-start mb-3 gap-2">
                              <h3 className="font-extrabold uppercase text-lg sm:text-xl text-black group-hover:text-[#965F0E] transition-colors tracking-tight leading-tight">
                                {property.title}
                              </h3>
                              <button 
                                onClick={() => toggleFavorite(property.id)}
                                className={`w-9 h-9 rounded-full border flex items-center justify-center transition-all cursor-pointer bg-white shrink-0 ${
                            ...
                            <div className="flex items-center gap-1 text-gray-400 mb-5">
                              <span className="material-symbols-outlined text-[#965F0E] text-[16px] font-bold">location_on</span>
                              <span className="text-xs font-body-md truncate">{property.location}</span>
                            </div>

                            {/* Info specification stats with separator */}
                            <div className="flex items-center gap-6 py-4.5 border-y border-gray-100 mb-6 text-gray-700">
                              <div className="flex items-center gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[17px] font-bold">bed</span>
                                <span className="text-xs font-bold">{property.bedrooms} <span className="text-gray-400 font-normal">Beds</span></span>
                              </div>
                              <div className="flex items-center gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[17px] font-bold">bathtub</span>
                                <span className="text-xs font-bold">{property.bathrooms} <span className="text-gray-400 font-normal">Baths</span></span>
                              </div>
                              <div className="flex items-center gap-1.5">
                                <span className="material-symbols-outlined text-[#965F0E] text-[17px] font-bold">layers</span>
                                <span className="text-xs font-bold">{property.floors} <span className="text-gray-400 font-normal">Floors</span></span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between gap-3 mt-auto pt-1">
                            ...
                            >
                              VIEW DETAILS
                              <span className="material-symbols-outlined text-[15px] font-bold">arrow_outward</span>
                            </button>
                ...
                <div className="text-center py-20 bg-gray-50 rounded-lg border border-gray-100">
                  <span className="material-symbols-outlined text-gray-300 text-5xl mb-3">houseboat</span>
                  <h3 className="font-extrabold text-black uppercase tracking-tight text-sm">No properties found</h3>
                  <p className="font-body-md text-gray-400 text-xs mt-1">Try resetting your keywords or searching for other prime areas.</p>
                </div>
              )}
            </section>
          </div>
      ...
      <footer className="bg-[#0f1c2e] text-white py-14 mt-auto border-t border-gray-800">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex flex-col items-center gap-6">
            ...
            {/* White Silhouette/Outline Icon */}
            <div className="bg-white/10 w-9 h-9 flex items-center justify-center font-extrabold text-white text-lg rounded-xs">
              S
            </div>
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="relative mb-6">
              <input 
                ...
                placeholder="Type location or name (e.g., Manhattan)..." 
            ...
            <div className="space-y-3 max-h-[40vh] overflow-y-auto pr-1">
              {filteredProperties.length > 0 ? (
                ...
                <div className="text-gray-400 text-center text-xs py-6">No properties match "{searchQuery}"</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg max-w-sm w-full shadow-xl p-6 relative border border-gray-100">
            ...
            {contactSubmitted ? (
              <div className="bg-green-50 border border-green-100 text-green-800 p-5 rounded text-center">
                ...
                <h4 className="text-sm font-bold uppercase mb-1">Message Transmitted!</h4>
                <p className="text-xs text-green-700">Thank you. Our specialists will contact you inside 24 hours.</p>
              </div>
            ) : (
              <form onSubmit={handleContactSubmit} className="space-y-4.5">
                <div>
                  <label className="block text-[10px] font-bold text-gray-700 uppercase tracking-widest mb-1">Your Name *</label>
                  <input 
                    type="text" 
                    required 
                    value={contactName}
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-700 uppercase tracking-widest mb-1">Message</label>
                  <textarea 
                    rows={3}
                    value={contactMsg}
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full shadow-2xl overflow-hidden relative border border-gray-100 my-4">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              ...
              <button 
                ...
                className="bg-gray-100 hover:bg-gray-200 text-gray-800 p-2 rounded-full transition-all cursor-pointer flex items-center justify-center"
                title="Tutup Halaman"
                id="close-modal-btn"
              >
            ...
            <div className="p-5 md:p-6 space-y-5 max-h-[80vh] overflow-y-auto">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                <h4 className="font-extrabold text-[10px] uppercase text-[#965F0E] tracking-widest mb-3">Property Information</h4>
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-white p-2.5 rounded border border-gray-100 flex items-center gap-2.5">
                    <span className="material-symbols-outlined text-[#965F0E] text-lg font-bold">bed</span>
                    <div>
                  ...
                  <div className="bg-white p-2.5 rounded border border-gray-100 flex items-center gap-2.5">
                    <span className="material-symbols-outlined text-[#965F0E] text-lg font-bold">bathtub</span>
                    <div>
                      <div className="text-[9px] text-gray-400 uppercase font-bold leading-none">Kamar Mandi</div>
                      <div className="text-xs font-extrabold text-black mt-0.5">{selectedProperty.bathrooms} Kamar Mandi</div>
                    </div>
                  </div>
                  <div className="bg-white p-2.5 rounded border border-gray-100 flex items-center gap-2.5">
                    <span className="material-symbols-outlined text-[#965F0E] text-lg font-bold">layers</span>
                    <div>
